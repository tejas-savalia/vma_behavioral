...
def fit_single_cv(participant, errors, p_type, train_indices, test_indices):
    ...
    res = minimize(calc_log_likelihood, x0=starting_point, args=(errors, 'single state', p_type, 'cv', train_indices), bounds=((0.0001, 1), (0, 0.9999), (0.01, 5)), method = 'L-BFGS-B')
...
def fit_dual_cv(participant, errors, p_type, train_indices, test_indices):
    ...
    res = minimize(calc_log_likelihood, x0=starting_point, args=(errors, 'dual state', p_type, 'cv', train_indices), bounds=((0, 1), (0, 1), (0, As_single), (Bs_single, 1), (0.01, 5)), method = 'L-BFGS-B')
